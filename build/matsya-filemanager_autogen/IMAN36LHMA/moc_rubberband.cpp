...
QT_MOC_LITERAL(3, 25, 10), // "intersects"
QT_MOC_LITERAL(4, 36, 4), // "rect"
QT_MOC_LITERAL(5, 41, 5) // "color"

    },
    "RubberBand\0colorChanged\0\0intersects\0"
    "rect\0color"
};
...
static const uint qt_meta_data_RubberBand[] = {
 ...
 // methods: parameters
    QMetaType::Bool, QMetaType::QRectF,    4,
...
void RubberBand::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->intersects((*reinterpret_cast< const QRectF(*)>(_a[1])));
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RubberBand::colorChanged)) {
                *result = 0;
                return;
            }
        }
